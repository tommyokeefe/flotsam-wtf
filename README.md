...
npm run publish:documents  # audit, then make the PDS match dist/posts.json; -- --dry-run to preview, -- --max-deletions <n> for a bigger clear-out (see the script header)
